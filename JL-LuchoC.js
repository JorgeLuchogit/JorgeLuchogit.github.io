...
const enlaces = document.querySelectorAll('.header__nav-item');
...
document.getElementById('SobreMiLinkFoot').addEventListener('click', function(){
    skills.checked = true
});
...
document.getElementById('homeLinkFoot').addEventListener('click', function(){
    skills.checked = false;
    mensaje.style.display = 'none';
    document.getElementById(x).checked = false;
    barra.style.width = '2%';
...
for (radio of lenguajeRadiusList){
    ...
    radio.addEventListener('click', function(){
        ...
        experiencia.innerHTML = "Experiencia en "+ lenguajeDiccionario[seleccionado][0] + ":";
