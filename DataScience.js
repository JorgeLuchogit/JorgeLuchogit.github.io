...
let proyecto_detalles = {
    ...
    'radio6': ['Imagenes/Jl_FreeTimeC.png', '<h2>JL-FreeTime (Diseño de base de datos SQL)</h2>', `<iframe class="sismos" title="sismos contenido" src="JL-FreeTime.html" frameborder="0"></iframe>`, 'https://github.com/JorgeLuchogit/Mis-proyectos-de-Data-Science/tree/master/JL-FreeTime%20(dise%C3%B1o%20de%20base%20de%20datos%20SQL)', '<div class="herramientas" id="herramientas"><h4>Herramientas:</h4><p>Python (sqlite3, pandas) <br> SQL (Sqlite)</p></div>', `<img style="width: 95%;filter:invert(100%) ;" src="Imagenes/Jl_FreeTimeC.png" alt="Diagrama de la base de datos" >`, 'Propone una base de datos que el usuario puede utilizar para registrar sus actividades diarias para un posterior análisis del aprovechamiento de su tiempo. <br><br> En el repositorio de GitHub se anexa un script de Python con el cual pueden realizarse registros de uno o más aspecto de manera automática, lo que ahorra tiempo y es más cómodo. <br><br> Este proyecto continuará con la realización de un análisis automático de los datos recopilados a lo largo del tiempo <b> (En desarrollo)</b>']
};
